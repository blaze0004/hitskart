...
<div class="content-ex" style="text-align:left"><?=$mesaj?>
	<form action="" method="post">
			<p>
				...
				<input class="text-max" type="email" value="<?=(isset($_POST['email']) ? $_POST['email'] : '')?>" name="email" required />
			</p>
			<?
				if($site['captcha_sys'] != 3){
			?>
			<p>
				...
				<span style="margin-left:2px;display:inline;position:absolute"><input class="l_form" type="text" value="" name="captcha" required /></span>
				<?}?>
			</p>
			<?}?>
			<p>
...
if($site['reg_status'] == 0){
	...
	if(isset($_POST['register'])){
		...
		$offerclick = $db->EscapeString($_POST['offerclick']);
