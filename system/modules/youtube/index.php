...
register_filter('free_coins','yt_icon_free');
function yt_icon_free($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=youtube"><img class="exchange_icon" src="img/icons/youtube.png" alt="Youtube" /><br/><p>Youtube Views</p></a></th></tr><tr>';
}  
register_filter('free_coins_main','yt_icon_main');
function yt_icon_main($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=youtube"><img class="exchange_icon" src="img/icons/youtube.png" alt="Youtube" /><br/><p>Youtube Views</p></a></th></tr><tr>';
}                     
register_filter('top_menu_earn','yt_top_menu');
function yt_top_menu($menu) {
	$selected = (isset($_GET["p"]) && $_GET["p"] == "youtube" ? ' active' : '');
	return $menu . '<div class="ucp_link'.$selected.'"><img class="exchange_icon" src="img/icons/youtube.png" align="left" alt="Youtube" /><a href="p.php?p=youtube"><div>Youtube Views</div></a></div>';
}
