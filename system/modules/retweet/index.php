...
register_filter('free_coins_main','rtt_icon_main');
function rtt_icon_main($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=retweet"><img class="exchange_icon" src="img/icons/tweet.png" alt="Tweet" /><br/><p>Twitter Followers</p></a></th>';
}
