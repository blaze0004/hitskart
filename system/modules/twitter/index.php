...
register_filter('free_coins','twitter_icon_free');
function twitter_icon_free($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=twitter"><img class="exchange_icon" src="img/icons/twitter.png" alt="Twitter" /><br/><p>Twitter Followers</p></a></th>';
}
register_filter('free_coins_main','twitter_icon_main');
function twitter_icon_main($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=twitter"><img class="exchange_icon" src="img/icons/twitter.png" alt="Twitter" /><br/><p>Twitter Followers</p></a></th>';
}
register_filter('top_menu_earn','twitter_top_menu');
function twitter_top_menu($menu) {
	$selected = (isset($_GET["p"]) && $_GET["p"] == "twitter" ? ' active' : '');
	return $menu . '<div class="ucp_link'.$selected.'"><img class="exchange_icon" src="img/icons/twitter.png" align="left" alt="Twitter" /><a href="p.php?p=twitter"><div>Twitter</div></a></div>';
}
