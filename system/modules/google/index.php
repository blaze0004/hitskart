...
register_filter('free_coins','ggl_icon_free');
function ggl_icon_free($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=google"><img class="exchange_icon" src="img/icons/google.png" alt="Google" /><br/><p>Google+</p></a></th>';
}       
register_filter('free_coins_main','ggl_icon_main');
function ggl_icon_main($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=google"><img class="exchange_icon" src="img/icons/google.png" alt="Google" /><br/><p>Google+</p></a></th>';
}
register_filter('top_menu_earn','ggl_top_menu');
function ggl_top_menu($menu) {
	$selected = (isset($_GET["p"]) && $_GET["p"] == "google" ? ' active' : '');
	return $menu . '<div class="ucp_link'.$selected.'"><img class="exchange_icon" src="img/icons/google.png" align="left" alt="Google" /><a href="p.php?p=google"><div>Google +1</div></a></div>';
}
