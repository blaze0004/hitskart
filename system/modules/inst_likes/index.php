...
function inst_likes_icon_on($icons) {
...
function inst_likes_icon_off($icons) {
	return $icons . '<img class="exchange_icon" src="img/icons/instagram.png" alt="Instagram" />';
}
register_filter('free_coins','inst_icon_free');
function inst_icon_free($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=instagram"><img class="exchange_icon" src="img/icons/instagram.png" alt="Instagram" border="0" /><br/><p>Instagram Likes</p></a></th></tr><tr>';
}
register_filter('free_coins_main','inst_icon_main');
function inst_icon_main($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=instagram"><img class="exchange_icon" src="img/icons/instagram.png" alt="Instagram" border="0" /><br/><p>Instagram Likes</p></a></th>';
}
...
function inst_likes_top_menu($menu) {
	...
	return $menu . '<div class="ucp_link'.$selected.'"><img class="exchange_icon" src="img/icons/instagram.png" alt="Instagram" align="left" /><a href="p.php?p=inst_likes"><div>Instagram Likes</div></a></div>';
}
