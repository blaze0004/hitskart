...
register_filter('free_coins','reverbnation_icon_free');
function reverbnation_icon_free($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=reverbnation"><img class="exchange_icon" src="img/icons/reverbnation.png" alt="ReverbNation" /><br/><p>Reverbnation Fans</p></a></th>';
}
register_filter('free_coins_main','reverbnation_icon_main');
function reverbnation_icon_main($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=reverbnation"><img class="exchange_icon" src="img/icons/reverbnation.png" alt="ReverbNation" /><br/><p>Reverbnation Fans</p></a></th>';
}
...
function reverbnation_top_menu($menu) {
	...
	return $menu . '<div class="ucp_link'.$selected.'"><img class="exchange_icon" src="img/icons/reverbnation.png" alt="ReverbNation" align="left" /><a href="p.php?p=reverbnation"><div>Reverbnation Fans</div></a></div>';
}
