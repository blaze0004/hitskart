...
register_filter('free_coins','yfav_icon_free');
function yfav_icon_free($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=youtube"><img class="exchange_icon" src="img/icons/youtube.png" alt="Youtube" /><br/><p>Youtube Favorites</p></a></th>';
}   
register_filter('free_coins_main','yfav_icon_main');
function yfav_icon_main($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=youtube"><img class="exchange_icon" src="img/icons/youtube.png" alt="Youtube" /><br/><p>Youtube Favorites</p></a></th>';
}   
register_filter('top_menu_earn','yfav_top_menu');
function yfav_top_menu($menu) {
	$selected = (isset($_GET["p"]) && $_GET["p"] == "yfav" ? ' active' : '');
	return $menu . '<div class="ucp_link'.$selected.'"><img class="exchange_icon" src="img/icons/youtube.png" align="left" alt="Youtube" /><a href="p.php?p=yfav"><div>Youtube Favorites</div></a></div>';
}
