...
register_filter('free_coins','su_icon_free');
function su_icon_free($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=su"><img class="exchange_icon" src="img/icons/stumbleupon.png" alt="StumbleUpon" /><br/><p>Stumbleupon</p></a></th></tr><tr>';
}
register_filter('free_coins_main','su_icon_main');
function su_icon_main($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=su"><img class="exchange_icon" src="img/icons/stumbleupon.png" alt="StumbleUpon" /><br/><p>Stumbleupon</p></a></th>';
}
...
function su_top_menu($menu) {
	...
	return $menu . '<div class="ucp_link'.$selected.'"><img class="exchange_icon" src="img/icons/stumbleupon.png" align="left" alt="StumbleUpon" /><a href="p.php?p=su"><div>Stumbleupon</div></a></div>';
}
