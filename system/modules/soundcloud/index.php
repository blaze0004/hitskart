...
register_filter('free_coins','soundcloud_icon_free');
function soundcloud_icon_free($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=soundcloud"><img class="exchange_icon" src="img/icons/soundcloud.png" alt="Soundcloud" /><br/><p>SoundCloud Followers</p></a></th>';
}
register_filter('free_coins_main','soundcloud_icon_main');
function soundcloud_icon_main($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=soundcloud"><img class="exchange_icon" src="img/icons/soundcloud.png" alt="Soundcloud" /><br/><p>SoundCloud Followers</p></a></th>';
}
...
function soundcloud_top_menu($menu) {
	...
	return $menu . '<div class="ucp_link'.$selected.'"><img class="exchange_icon" src="img/icons/soundcloud.png" align="left" alt="Soundcloud" /><a href="p.php?p=soundcloud"><div>Soundcloud Followers</div></a></div>';
}
