...
register_filter('free_coins','ylike_icon_free');
function ylike_icon_free($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=ylike"><img class="exchange_icon" src="img/icons/ylike.png" alt="YLike" /><br/><p>Youtube Likes</p></a></th>';
}  
register_filter('free_coins_main','ylike_icon_main');
function ylike_icon_main($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=ylike"><img class="exchange_icon" src="img/icons/ylike.png" alt="YLike" /><br/><p>Youtube Likes</p></a></th>';
}                 
register_filter('top_menu_earn','ylike_top_menu');
function ylike_top_menu($menu) {
	$selected = (isset($_GET["p"]) && $_GET["p"] == "ylike" ? ' active' : '');
	return $menu . '<div class="ucp_link'.$selected.'"><img class="exchange_icon" src="img/icons/ylike.png" align="left" alt="YLike" /><a href="p.php?p=ylike"><div>Youtube Likes</div></a></div>';
}
