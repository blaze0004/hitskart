...
function get_likes($url){
	global $site;
	$url = get_data_curl('https://www.googleapis.com/youtube/v3/videos?part=statistics&id='.$url.'&key='.$site['yt_api']);
	$entry = json_decode($url, true); 
	return $entry['items'][0]['statistics']['likeCount'];
}
