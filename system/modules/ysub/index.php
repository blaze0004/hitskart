...
register_filter('free_coins','ysub_icon_free');
function ysub_icon_free($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=ysub"><img class="exchange_icon" src="img/icons/ysub.png" alt="YSub" /><br/><p>Youtube Subscribers</p></a></th>';
}  
register_filter('free_coins_main','ysub_icon_main');
function ysub_icon_main($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=ysub"><img class="exchange_icon" src="img/icons/ysub.png" alt="YSub" /><br/><p>Youtube Subscribers</p></a></th>';
}                           
register_filter('top_menu_earn','ysub_top_menu');
function ysub_top_menu($menu) {
	$selected = (isset($_GET["p"]) && $_GET["p"] == "ysub" ? ' active' : '');
	return $menu . '<div class="ucp_link'.$selected.'"><img class="exchange_icon" src="img/icons/ysub.png" align="left" alt="YSub" /><a href="p.php?p=ysub"><div>Youtube Subscribers</div></a></div>';
}
