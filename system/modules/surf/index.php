...
register_filter('free_coins','surf_icon_free');
function surf_icon_free($freeicons) {
	return $freeicons . '<th align="center"><a href="'.($site['surf_type'] == 0 ? 'surf.php' : 'p.php?p=surf').'"><img class="exchange_icon" src="img/icons/feed.png" alt="Hits" /><br/><p>Website Hits</p></a></th>';
}
register_filter('free_coins_main','surf_icon_main');
function surf_icon_main($freeicons) {
	return $freeicons . '<th align="center"><a href="'.($site['surf_type'] == 0 ? 'surf.php' : 'p.php?p=surf').'"><img class="exchange_icon" src="img/icons/feed.png" alt="Hits" /><br/><p>Website Hits</p></a></th></tr><tr>';
}
...
function surf_top_menu($menu) {
	...
	if($site['surf_type'] == 0){
		return $menu . '<div class="ucp_link"><a target="_blank" href="surf.php"><div>Traffic Exchange</div></a></div>';
	}else{
		return $menu . '<div class="ucp_link'.$selected.'"><img class="exchange_icon" src="img/icons/feed.png" align="left" alt="Hits" /><a href="p.php?p=surf"><div>Website Hits</div></a></div>';
	}
}
