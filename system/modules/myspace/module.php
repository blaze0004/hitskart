...
<?
	...
	if(empty($check_acc['account_username'])){
		...
		if(isset($_POST['submit']) && !empty($_POST['mys_url'])){
			...
			$html = get_data('https://myspace.com/'.strtolower($mys_url));
