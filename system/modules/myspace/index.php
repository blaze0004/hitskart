...
register_filter('free_coins','myspace_icon_free');
function myspace_icon_free($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=myspace"><img class="exchange_icon" src="img/icons/myspace.png" alt="MySpace" /><br/><p>Myspace Connections</p></a></th>';
}   
register_filter('free_coins_main','myspace_icon_main');
function myspace_icon_main($freeicons) {
	return $freeicons . '<th align="center"><a href="p.php?p=myspace"><img class="exchange_icon" src="img/icons/myspace.png" alt="MySpace" /><br/><p>Myspace Connections</p></a></th>';
}    
register_filter('top_menu_earn','myspace_top_menu');
function myspace_top_menu($menu) {
	$selected = (isset($_GET["p"]) && $_GET["p"] == "myspace" ? ' active' : '');
	return $menu . '<div class="ucp_link'.$selected.'"><img class="exchange_icon" src="img/icons/myspace.png" align="left" alt="MySpace" /><a href="p.php?p=myspace"><div>MySpace Connections</div></a></div>';
}
