...
<script type="text/javascript">
    ...
    <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
        ...
        <td id="surfbar_td" align="center" height="68" valign="top">
          ...
          <center>
            <table style="color:white;" width="100%" border="0" height="100%">
              <tr>
                <td width="380" style="background:url('/theme/<?=$site['theme']?>/images/logo.png') center left no-repeat;">&nbsp;</td>
      ...
      <tr style='height:100%;background:white;'>
        <td>
          <iframe id="pes_frame" src="<?=($sit['id'] == '' ? ($site['surf_type'] != 1 ? 'system/modules/surf/nocoins.html' : 'system/modules/surf/nopage.html') : hideref($sit['url'], ($site['hideref'] == 1 ? 1 : ($site['hideref'] == 2 ? 2 : 0)), (empty($site['revshare_api']) ? 0 : $site['revshare_api'])))?>" frameborder="0" style="width:100%; height:100%; overflow-x:hidden;" vspace="0" hspace="0"></iframe>
        </td>
      </tr>
    </table>  
    </div>
