	...
	<div >
		...
		<div class="aff_block">
            <div class="aff_content">              
                ...
                <center><input type="text" value="<?=$site['site_url']?>/?ref=<?=$data['id']?>" onclick="this.select()" style="font-size:11px;padding:4px;width:270px;margin:0 auto;" readonly /></center>
            ...
            <div class="aff_banner_title">Banner (468x60)</div><br> 
				<table width="100%" border="0" cellpadding="3" cellspacing="1">
					...
					<tr>    
						<td valign="top" align="center">
							<b><?=$lang['b_118']?></b><br>
							<textarea class="textarea" style="width:500px;height:60px" onclick="this.select()" readonly><a href="<?=$site['site_url']?>/?ref=<?=$data['id']?>" target="_blank"><img src="<?=$site['site_url']?>/promo/banner.png" alt="<?=$site['site_name']?>" border="0" /></a></textarea>
						</td>
					</tr>
					<tr>    
						<td valign="top" align="center">
							<b>BB Code</b><br>
							<textarea class="textarea" style="width:500px;height:30px" onclick="this.select()" readonly>[url=<?=$site['site_url']?>/?ref=<?=$data['id']?>][img]<?=$site['site_url']?>/promo/banner.png[/img][/url]</textarea>                        
						</td>
					</tr>                   
				</table>
        </div>
